...
macro_rules! config_definition {
    ($key:expr, $kind:expr, $default:expr) => {
        $crate::common::config::ConfigDefinition::new($key, $kind, $default)
    };
...
macro_rules! config_registry {
    ($(($key:expr, $kind:expr, $default:expr $(, [$($scope:expr),* $(,)?])?)),* $(,)?) => {{
        let mut registry = $crate::common::config::ConfigRegistry::new();
        registry
...
macro_rules! define_config_view {
    (
        ...
        impl $crate::common::config::ConfigView for $name {
            fn config_definitions() -> Vec<$crate::common::config::ConfigDefinition> {
                $crate::config_definitions!(
                    $(
                        (
                            $key,
                            $crate::common::config::ConfigValueKind::$kind,
                            $default
                            $(, [$($scope),*])?
                        )
                    ),*
            ...
            fn from_config_set(
                config: &$crate::common::config::ConfigSet,
            ) -> Result<Self, $crate::common::errors::CommonError> {
                Ok(Self {
                    $(
        ...
        $crate::common::config::inventory::submit! {
            $crate::common::config::ConfigDefinitionSetRegistration {
                collect: <$name as $crate::common::config::ConfigView>::config_definitions,
            }
        }
    };
