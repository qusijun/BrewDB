...
use crate::frontend::result::FrontendResponse;
use crate::frontend::result::ResultField;
...
impl ProtocolRegistry {
    ...
    pub fn with_builtin_plugins() -> Self {
        ...
        registry.register(Arc::new(crate::frontend::pgwire::PgWireCodec));
        registry
    }
...
mod tests {
    ...
    use crate::frontend::pgwire::PgWireCodec;
