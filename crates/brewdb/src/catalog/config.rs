...
mod tests {
    use crate::common::config::{
        global_config_registry, ConfigPatch, ConfigRegistry, ConfigScope, ConfigView,
    };

    use super::{
        CatalogConfig, CatalogStoreBackendKind, CATALOG_PAIMON_WAREHOUSE_KEY,
        CATALOG_STORE_BACKEND_KEY,
    };
