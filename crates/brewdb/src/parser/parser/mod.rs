...
impl<'a> Parser<'a> {
    ...
    /// Example:
    /// ```
    /// # use brewdb::{parser::{Parser, ParserError}, dialect::GenericDialect};
    ...
    /// Example:
    /// ```
    /// # use brewdb::{parser::{Parser, ParserError, ParserOptions}, dialect::GenericDialect};
    /// # fn main() -> Result<(), ParserError> {
    /// let dialect = GenericDialect{};
    ...
    /// Parses fulltext expressions [`brewdb::ast::Expr::MatchAgainst`]
    ///
    /// # Errors
    ...
    /// Example:
    /// ```rust
    /// # use brewdb::dialect::GenericDialect;
    /// # use brewdb::parser::Parser;
    /// # use brewdb::keywords::Keyword;
    /// # use brewdb::tokenizer::{Token, Word};
    /// let dialect = GenericDialect {};
    ...
    /// Example
    /// ```
    /// # use brewdb::parser::{Parser, ParserError};
    /// # use brewdb::dialect::GenericDialect;
    /// # fn main() ->Result<(), ParserError> {
