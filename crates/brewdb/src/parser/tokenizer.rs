...
impl Span {
    ...
    /// # Examples
    /// ```
    /// # use brewdb::tokenizer::{Span, Location};
...
/// # Examples
/// ```
/// # use brewdb::tokenizer::{Location, Span, Token, TokenWithSpan};
...
impl<'a> Tokenizer<'a> {
    ...
    ///
    /// ```
    /// # use brewdb::tokenizer::{Token, Whitespace, Tokenizer};
    ...
    ///
    /// ```
    /// # use brewdb::tokenizer::{Token, Tokenizer};
    /// # use brewdb::dialect::GenericDialect;
    /// # let dialect = GenericDialect{};
    /// let query = r#""Foo "" Bar""#;
