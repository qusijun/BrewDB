...
///
/// ```
/// use brewdb::derive_dialect;
/// use brewdb::dialect::{Dialect, GenericDialect};
///
...
/// ```
/// use brewdb::derive_dialect;
/// use brewdb::dialect::{Dialect, PostgreSqlDialect};
///
...
///
/// ```
/// # use brewdb::dialect::AnsiDialect;
...
///
/// ```
/// # use brewdb::dialect::{AnsiDialect, dialect_from_str};
