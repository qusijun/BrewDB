...
use crate::ast::{
    ...
    DistStyle, DistributedBy, Expr, FileFormat, ForValues, HiveDistributionStyle, HiveFormat,
...
/// # Example
/// ```rust
/// use brewdb_parser::ast::helpers::stmt_create_table::CreateTableBuilder;
/// use brewdb_parser::ast::{ColumnDef, DataType, Ident, ObjectName};
...
pub struct CreateTableBuilder {
    ...
    /// Optional BrewDB/Paimon `PARTITIONED BY` column list.
    pub partitioned_by: Vec<Ident>,
    ...
    /// BrewDB/Paimon `DISTRIBUTED BY` clause.
    pub distributed_by: Option<DistributedBy>,
}
...
impl CreateTableBuilder {
    ...
    /// Set BrewDB/Paimon `PARTITIONED BY` columns.
    pub fn partitioned_by(mut self, partitioned_by: Vec<Ident>) -> Self {
    ...
    /// Set BrewDB/Paimon `DISTRIBUTED BY` clause.
    pub fn distributed_by(mut self, distributed_by: Option<DistributedBy>) -> Self {
...
impl From<CreateTable> for CreateTableBuilder {
    fn from(table: CreateTable) -> Self {
        Self {
            ...
            backup: table.backup,
            distributed_by: table.distributed_by,
        }
    }
}
