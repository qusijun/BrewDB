...
///
/// ```
/// use brewdb_parser::derive_dialect;
/// use brewdb_parser::dialect::{Dialect, GenericDialect};
///
...
/// ```
/// use brewdb_parser::derive_dialect;
/// use brewdb_parser::dialect::{Dialect, PostgreSqlDialect};
///
...
///
/// ```
/// # use brewdb_parser::dialect::AnsiDialect;
...
///
/// ```
/// # use brewdb_parser::dialect::{AnsiDialect, dialect_from_str};
