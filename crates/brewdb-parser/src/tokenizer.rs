...
/// ```
/// # use brewdb_parser::tokenizer::Location;
...
impl Span {
    ...
    /// # Examples
    /// ```
    /// # use brewdb_parser::tokenizer::{Span, Location};
...
/// # Examples
/// ```
/// # use brewdb_parser::tokenizer::{Location, Span, Token, TokenWithSpan};
...
impl<'a> Tokenizer<'a> {
    ...
    ///
    /// ```
    /// # use brewdb_parser::tokenizer::{Token, Whitespace, Tokenizer};
    ...
    ///
    /// ```
    /// # use brewdb_parser::tokenizer::{Token, Tokenizer};
    /// # use brewdb_parser::dialect::GenericDialect;
    /// # let dialect = GenericDialect{};
    /// let query = r#""Foo "" Bar""#;
